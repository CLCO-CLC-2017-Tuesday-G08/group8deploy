...
<html>
	<head>
		<script src="/resources/Portlets/PanelBar/js/jquery-1.7.2.min.js"></script>
		...
		<div class="container">
				...
				<div class="slider-wrapper theme-default">
					<div id="slider" class="nivoSlider">
						<a href="#" target="_blank"> <img
							src="<c:url value = "/resources/WELCOME TO ICSSE 2017_files/HNQT3.jpg"/>"
							title="" /></a> <a href="#" target="_blank"> <img
							src="<c:url value = "/resources/WELCOME TO ICSSE 2017_files/HNQT2.jpg"/>"
							title="" /></a> <a href="#" target="_blank"> <img
							src="<c:url value = "/resources/WELCOME TO ICSSE 2017_files/HNQT1.jpg"/>"
							title="" /></a>
					</div>
				</div>
			</div>
			...
			<script>
				$(document).ready(function() {
					...
					$('.nivoSlider img').css('height', 'auto');
				})
			</script>
